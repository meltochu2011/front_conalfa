...
@Component({
  selector: 'app-syllable-list',
  templateUrl: './syllable-list.component.html',
  styleUrls: ['./syllable-list.component.css']
})
export class SyllableListComponent {
...
get_syllables()
{
  ...
  this.profesorservice.get_syllables().subscribe(
   
    res=> { 
      this.syllable_items=res;     
      this.loading_modaldetail_gif=false;  
      document.body.style.cursor = 'default';
      console.log(this.syllable_items);      
    },
    err=> {
